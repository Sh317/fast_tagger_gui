...
def main_loop(tagger, measurement_name, voltage_reader, wavenumber_reader, initialization_params=initialization_params, spectrometer_reader=None):
    """
    ...
    i_time = time.time()
    try:
        spec = spectrometer_reader.get_spec()
    except Exception as e:
...
if __name__ == "__main__":
    ...
    try:
        main_loop(tagger, measurement_name, voltage_reader, wavenumber_reader, initialization_params, spectrometer_reader)
